...
//	}
	...
	protected void refreshCache() {
		if (!AppConstant.AUTH_PROVIDER_NAME_ENTRAID_OPENID.equalsIgnoreCase(ConfigFactory.appConfigService
			...
			String info = "EntraIdJwksCache.refreshCache()...... Authentication Provider is not "
					+ AppConstant.AUTH_PROVIDER_NAME_ENTRAID_OPENID + ", no cache is needed, do nothing......";
			logger.info(info);
